...
2. Run ``cookiecutter`` on the template::
    ...
    $ cookiecutter https://github.com/beeware/briefcase-macOS-app-template --checkout 3.10
...
.. _Download the Python Apple support package for macOS: https://briefcase-support.org/python?platform=macOS&version=3.10
