...
**This repository branch contains the code to generate the app template**.
Templates for different Python versions are available by cloning other branches of repository.
...
3. `Download the Python Apple support package for macOS`_, extract it, and copy the Python
   standard library to ``My Project/My Project.app/Contents/Resources/Python/lib``.

   Alternatively, you can download the `Python-Apple-support`_ project, build your own version,
   and manually choose which modules to include in your app.
